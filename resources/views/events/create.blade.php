                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date" id="startAt" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="startAt" data-target="#startAt" value="{{ old('startAt') }}" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date" id="endAt" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="endAt" data-target="#endAt"  value="{{ old('endAt') }}"/>
